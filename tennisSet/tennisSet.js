...
let score1 = 3;
let score2 = 6;     // the output should be solution(score1, score2) = true.

score1 = 8;
score2 = 5;     // the output should be solution(score1, score2) = false.

score1 = 6;
score2 = 5;     // the output should be solution(score1, score2) = false.

score1 = 7;
score2 = 7;     // the output should be solution(score1, score2) = false.

score1 = 7;
score2 = 2;     // the output should be solution(score1, score2) = false.

score1 = 7;
score2 = 5;     // the output should be solution(score1, score2) = true.

score1 = 7;
score2 = 6;     // the output should be solution(score1, score2) = true.
...
if (score1 == score2)
    ...
    else if (score1 + 2 >= score2 || score1 <= score2 + 2)
    {
        return true;
    }
